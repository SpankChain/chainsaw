...
class Chainsaw {
  ...
  **/
  constructLogs (dLog, i, decodedLogs, logsInTheBlock) {
    ...
    dLog['sender'] = logsInTheBlock[dLog['logIndex'] - 1]['sender']
    dLog['receiver'] = logsInTheBlock[dLog['logIndex'] - 1]['receiver']
    dLog['eventType'] = dLog['name']
    dLog['fields'] = dLog['events']
    dLog['ts'] = logsInTheBlock[dLog['logIndex'] - 1]['timestamp']
    return dLog
  }
  /**
